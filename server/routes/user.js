...
router.post("/sendInvitationMail",auth,async(req,res)=>{
  try{
    ...
    mailSender(email,"Invitation to play on bit2byte!",`
    <!DOCTYPE html>
<html lang="en">
...
<body>
  <div class="email-container">
    ...
    <a class="button" href="${"http://localhost:3000/pages/game-screen/"+link}" target="_blank">Play Now</a>
    <p>If the button above doesn't work, you can copy and paste the following link into your browser:</p>
    <p>${"http://localhost:3000/pages/game-screen/"+link}</p>
