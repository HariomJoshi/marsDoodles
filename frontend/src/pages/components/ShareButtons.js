...
const ShareButtons = ({ shareUrl }) => {
  ...
  return (
    <>
      <button
        onClick={() => shareOnFacebook(shareUrl, title)}
        style={{ padding: "10px" }}
      >
        <FacebookIcon size={40} borderRadius={15} />
      </button>
      <button
        onClick={() => shareOnTwitter(shareUrl, title)}
        style={{ padding: "10px" }}
      >
        <TwitterIcon size={40} borderRadius={15} />
      </button>
      <button
        onClick={() => shareOnWhatsApp(shareUrl, title)}
        style={{ padding: "10px" }}
      >
        <WhatsappIcon size={40} borderRadius={15} />
      </button>
      <button
        onClick={() => shareOnLinkedIn(shareUrl, title)}
        style={{ padding: "10px" }}
      >
